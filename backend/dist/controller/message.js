...
const postMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const savedMessage = yield message_1.default.create({ message });
        res.status(201).json({
            success: true,
...
const getMessages = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Fetch only the message field from the messages collection
        const allMessages = yield message_1.default.find().select('message');
        res.status(200).json({
            success: true,
